...
image::https://github.com/PasqualeMoramarco/Open-Liberty_poc/blob/dev_olpoc/assets/reactive-messaging-system-inventory-rest.png[Reactive system inventory, align="center"]
